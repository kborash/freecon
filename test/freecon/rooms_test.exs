defmodule Freecon.RoomsTest do
  ...
  describe "rooms" do
    ...
    @valid_attrs %{active: true, code: "some code", name: "some name"}
    @update_attrs %{active: false, code: "some updated code", name: "some updated name"}
    @invalid_attrs %{active: nil, code: nil, name: nil}
